...
import static com.five.sixse.activity.BookMarkReadingActivity.seekBar;
import static com.five.sixse.activity.BookMarkReadingActivity.playPause;
...
public class BookmarkReadingAdapter extends PagerAdapter {
    ...
    public BookmarkReadingAdapter(Activity activity, ArrayList<Book> chapterList) {
    ...
    public View instantiateItem(ViewGroup container, final int position) {
            ...
            public void onClick(View v) {
                if (chapterList.size() != 0) {
                    ...
                    if (tag.equalsIgnoreCase("play") && tag1.equalsIgnoreCase("play")) {
                        ...
                        Utility.startAutoScrolling(activity, (NestedScrollView) BookmarkReadingFragment.view.findViewById(R.id.vertical_scrollview_id));
        ...
        if (preferences.getString(Constants.PREF_LANGUAGE, Constants.PREF_LANGUAGE_ENG).equals(Constants.PREF_LANGUAGE_ENG)) {
            title = MainActivity.dba.getTitle(chapterList.get(BookmarkReadingFragment.pager.getCurrentItem()).getId(), Constants.VAR_ENG);
            ...
            title = MainActivity.dba.getTitle(chapterList.get(BookmarkReadingFragment.pager.getCurrentItem()).getId(), Constants.VAR_HINDI);
            ...
            title = MainActivity.dba.getTitle(chapterList.get(BookmarkReadingFragment.pager.getCurrentItem()).getId(), Constants.VAR_FRENCH);
        ...
        BookMarkReadingActivity.noteAddFab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(activity, NoteAddActivity.class);
                intent.putExtra("v_id", chapterList.get(BookmarkReadingFragment.pager.getCurrentItem()).getId());
        ...
        if (search != null && !search.equalsIgnoreCase("")) {
            ...
            if (start < 0) {
                ...
                while (start >= 0) {
                    ...
                    highlighted.setSpan(new BackgroundColorSpan(activity.getResources().getColor(R.color.Khaki)), spanStart, spanEnd, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
