...
/**
 * Created by bhavana on 3/13/2018.
 */
...
public class BookmarkListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    /*    preferences = PreferenceManager.getDefaultSharedPreferences(context);
        if (preferences.getString(Constants.PREF_LANGUAGE, Constants.PREF_LANGUAGE_ENG).equals(Constants.PREF_LANGUAGE_ENG)) {
            ...
            indexHolder.id.setText(String.valueOf(bookArrayList.get(position).getId()));
        ...
        indexHolder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(context, BookMarkReadingActivity.class);
